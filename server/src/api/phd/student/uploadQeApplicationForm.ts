...
export default router.post(
    ...
    asyncHandler(async (req, res) => {
        ...
        const { fileUrl, formName, applicationType, qualifyingArea1, qualifyingArea2 } = parsed.data;
        ...
        res.status(200).json({ success: true, message: "Application uploaded successfully" });
    })
);
